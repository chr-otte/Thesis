...
class PersistentCache:
    ...
    def __new__(cls, cache_dir="./SrfcaFlower_cache"):
...
class SrfcaFlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        # Set up optimizer
        optimizer = torch.optim.Adam(self.model.parameters(), lr=default_lr)
